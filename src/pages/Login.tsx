      ...
      <PhoneFrame>
        <div className="h-full flex flex-col pt-12 pb-8 px-6">
          ...
          <button 
            ...
            className="w-10 h-10 rounded-full bg-card flex items-center justify-center mb-8 shadow-card"
          >
            <ArrowLeft className="w-5 h-5 text-foreground" />
          </button>

          <div className="flex-1">
            <div className="w-14 h-14 gradient-primary rounded-2xl flex items-center justify-center mb-6 shadow-soft">
